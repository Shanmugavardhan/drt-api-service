...
describe('API Config', () => {
  ...
  describe("getGatewayUrl", () => {
    it("should return gateway url", () => {
      jest
        ...
        .mockImplementation(jest.fn(() => ['https://gateway.dharitri.org']));

      const results = apiConfigService.getGatewayUrl();
      expect(results).toEqual('https://gateway.dharitri.org');
    });
  ...
  describe("getVerifierUrl", () => {
    it("should return verifier (play-api.dharitri.org) url", () => {
      jest
        .spyOn(ConfigService.prototype, "get")
        .mockImplementation(jest.fn(() => 'https://play-api.dharitri.org'));

      const results = apiConfigService.getVerifierUrl();
      expect(results).toEqual('https://play-api.dharitri.org');
    });
  ...
  describe("getElasticUrl", () => {
    it("should return elastic url", () => {
      jest
        .spyOn(ConfigService.prototype, "get")
        .mockImplementation(jest.fn(() => ['https://index.dharitri.org']));

      const results = apiConfigService.getElasticUrl();
      expect(results).toEqual('https://index.dharitri.org');
    });
  ...
  describe("getDcdtContractAddress", () => {
    ...
    it("should throw error because test simulates that dcdt contract address is not defined", () => {
      ...
      expect(() => apiConfigService.getDcdtContractAddress()).toThrowError('No DCDT contract present');
    });
  });
  ...
  describe("getProvidersUrl", () => {
    it("should return providers url", () => {
      jest
        .spyOn(ConfigService.prototype, "get")
        .mockImplementation(jest.fn(() => 'https://internal-delegation-api.dharitri.org/providers'));

      const results = apiConfigService.getProvidersUrl();
      expect(results).toEqual('https://internal-delegation-api.dharitri.org/providers');
    });
  ...
  describe("getDataApiServiceUrl", () => {
    it("should return data api service url", () => {
      jest
        .spyOn(ConfigService.prototype, "get")
        .mockImplementation(jest.fn(() => 'https://data-api.dharitri.org'));

      const results = apiConfigService.getDataApiServiceUrl();
      expect(results).toEqual('https://data-api.dharitri.org');
    });
  ...
  describe("getMarketplaceServiceUrl", () => {
    it("should return marketplace service url", () => {
      jest
        .spyOn(ConfigService.prototype, "get")
        .mockImplementation(jest.fn(() => 'https://nfts-graph.dharitri.org/graphql'));

      const results = apiConfigService.getMarketplaceServiceUrl();
      expect(results).toEqual('https://nfts-graph.dharitri.org/graphql');
    });
  ...
  describe("getDelegationUrl", () => {
    it("should return delegation url", () => {
      jest
        .spyOn(ConfigService.prototype, "get")
        .mockImplementation(jest.fn(() => 'https://delegation-api.dharitri.org'));

      const results = apiConfigService.getDelegationUrl();
      expect(results).toEqual('https://delegation-api.dharitri.org');
    });
  ...
  describe("getSelfUrl", () => {
    it("should return self url", () => {
      jest
        .spyOn(ConfigService.prototype, "get")
        .mockImplementation(jest.fn(() => 'https://api.dharitri.org'));

      const results = apiConfigService.getSelfUrl();
      expect(results).toEqual('https://api.dharitri.org');
    });
